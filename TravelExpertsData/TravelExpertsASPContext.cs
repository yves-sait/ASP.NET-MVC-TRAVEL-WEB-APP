...
{
    public partial class TravelExpertsASPContext : DbContext
    {
        public TravelExpertsASPContext()
        {
        }

        public TravelExpertsASPContext(DbContextOptions<TravelExpertsASPContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            //optionsBuilder.UseSqlServer("Data Source=localhost\\sqlexpress;Initial Catalog=TravelExpertsASP ;Integrated Security=True");

            //Change the connection string here for your home computer/lab computer
            optionsBuilder.UseSqlServer(@"Server=localhost\sqlexpress;
                                          Database=TravelExpertsASP;
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.Property(e => e.CustPassword).HasDefaultValueSql("('password')");

                entity.Property(e => e.CustUsername).HasDefaultValueSql("('0')");
            ...
            modelBuilder.Entity<Province>(entity =>
            {
                ...
                entity.Property(e => e.Provname).IsUnicode(false);
            });
